...
<?
        ...
        $q_chkUprm = "SELECT ID from user_t where id='".$userid."';";
        ...
        $q_inPost = "INSERT INTO POST_T(ID, S_POSTER,S_SYNOP,S_TITLE,S_DEADLINE,START_DAY,LAST_DAY,S_GOALSUM ) VALUES('".$row_chkUprm['ID']."','".$filePoster."','".$fileSynop."','".$title."','".$deadLine."','".$startDate."','".$lastDate."','".$goalSum."'); ";
