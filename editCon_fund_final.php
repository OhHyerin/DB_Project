...
$sprm = $_GET['sprm'];
        ...
        $q_upFund = "UPDATE POST_T SET S_POSTER='".$filePoster."',S_SYNOP='".$fileSynop."',S_GOALSUM='".$goalSum."',S_DEADLINE='".$deadLine."',START_DAY='".$startDate."',LAST_DAY='".$lastDate."' WHERE S_PRM='".$sprm."' AND ID='".$uprm."';";
